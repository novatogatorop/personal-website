        ...
        >
          <div className="intro-col">
            <div className="intro-text-wrapper">
              ...
              <div className="intro-visit">
                {visit}
                <a target="_blank" href={webUrl} rel="noreferrer">
                  <Button buttonStyle="btn--plain">{webAppName}</Button>
                </a>
                <div className="intro-or">{or}</div>
                <a target="_blank" href={iosUrl} rel="noreferrer">
                  <Button buttonStyle="btn--plain">{iosAppName}</Button>
                </a>
              </div>
              <p className="intro-description">{description}</p>
              <Link to={detailPath}>
                <Button>{detailName}</Button>
              </Link>
              <a
                className="github"
                target="_blank"
